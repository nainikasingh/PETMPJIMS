...
def add_expense(request):
    ...
    if request.method == 'POST':
        ...
        # ⏫ Update training data if user changed prediction
        ...
        # 📈 Trigger forecast function
        try:
            forecast_data = generate_forecast(user)  # Assuming forecast is user-specific
            print("Forecast generated:", forecast_data)
